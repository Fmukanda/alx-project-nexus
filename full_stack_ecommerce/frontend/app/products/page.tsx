...
export default function ProductPage() {
  ...
  // Mock product data - with proper image structure
  const product = {
    id: '1',
  ...
  const getImageUrl = (image: any) => {
    ...
    return image?.image || image?.url || '/images/placeholder-product.jpg';
  };
            ...
            {product.images.map((image, index) => (
              <div
                ...
                style={{
                  ...
                  padding: '0.5rem',
                  cursor: 'pointer',
                  border: selectedImageIndex === index ? '2px solid #0284c7' : '1px solid #e5e7eb',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                }}
